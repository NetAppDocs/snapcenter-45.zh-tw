...
+
如需執行Cmdlet的資訊、請參閱 https://library.netapp.com/ecm/ecm_download_file/ECMLP2877143["《軟件指令程式參考指南》SnapCenter"]
...
* 將現有資料庫移至NetApp儲存設備。
+
如需詳細資訊、請參閱SnapCenter 「資訊的資料來源」。

+
link:concept_import_archived_backups_from_snapmanager_for_sql_to_snapcenter.html["將歸檔的備份從SnapManager Microsoft SQL Server的支援功能匯入SnapCenter 到支援功能"]

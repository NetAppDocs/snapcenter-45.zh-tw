...
您也可以手動或在指令碼中使用PowerShell Cmdlet來執行備份、還原及複製作業。支援的支援或SnapCenter https://library.netapp.com/ecm/ecm_download_file/ECMLP2877143["《軟件指令程式參考指南》SnapCenter"^] 包含PowerShell Cmdlet的詳細資訊。

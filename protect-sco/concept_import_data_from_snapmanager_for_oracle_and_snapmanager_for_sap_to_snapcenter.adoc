...
《Oracle資料庫適用的支援使用支援的組態SnapCenter 》（英文）列於中 https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT["NetApp 互通性對照表工具"^]。
